    ...
    <div class="container pt-100px pb-100px" data-aos="fade-up">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-30px">
        ...
        <div data-aos="fade-up">
          <h6
            class="text-2xl font-semibold text-blackColor dark:text-blackColor-dark leading-1.8 mb-15px"
          >
            Become an Instructor
          </h6>
          <p
            class="text-contentColor dark:text-contentColor-dark leading-1.8 mb-15px mt-5"
          >
