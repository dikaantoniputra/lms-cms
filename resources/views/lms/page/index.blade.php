...
<main class="bg-transparent">
      ...
      <div class="overflow-hidden relative z-0">
        ...
        <div>
          ...
          <img
            ...
            class="absolute left-1/2 bottom-[15%] md:left-[4%] lg:left-1/2 animate-spin-slow"
            alt=""
          >
          <img
        ...
        <div class="container pt-12 lg:pt-130px pb-175px relative">
          <div
            class="grid grid-cols-1 lg:grid-cols-12 items-center gap-12 md:gap-15 lg:gap-30px"
          >
            <!-- banner Left -->
            <div class="lg:col-start-1 lg:col-span-7" data-aos="fade-up">
              ...
              <h1
                class="text-size-40 text-blackColor lg:text-size-50 2xl:text-6xl leading-10 md:leading-18 lg:leading-62px 2xl:leading-18 md:tracking-half lg:tracking-normal 2xl:tracking-half font-bold mb-10px dark:text-blackColor-dark"
              >
                Cloud-based LMS <br class="hidden lg:block" >
                Trusted by 1000+
              </h1>
              <p
                class="text-size-15 lg:text-base 2xl:text-lg text-contentColor mb-5 2xl:mb-30px dark:text-contentColor-dark"
              >
              ...
              <div>
                <form class="flex gap-x-15px items-center flex-wrap gap-y-5">
                  <input
                    type="email"
                    placeholder="Your email address"
                    class="basis-[311px] h-14 leading-14 pl-3 border border-contentColor text-blackColor focus:outline-none rounded"
                  >
                  <button
                    type="submit"
                    class="text-size-15 text-whiteColor bg-primaryColor px-39px py-14px border border-primaryColor hover:text-primaryColor hover:bg-whiteColor inline-block rounded group dark:hover:text-whiteColor dark:hover:bg-whiteColor-dark"
                  >
                    Sign Up
                  </button>
                </form>
              ...
              <div class="tilt relative z-0">
                ...
                <div class="flex flex-col items-center lg:items-end">
                  <img
                    ...
                    alt=""
                  ><img
                    class="absolute left-0 bottom-[-93px] md:left-[30px] lg:left-0"
                    src="./assets/images/education/education__1.png"
                    alt=""
                  >
                  <img
                    src="./assets/images/education/education__2.png"
                    class="absolute left-5 top-10 md:left-[30px] lg:left-5 -z-10"
                    alt=""
                  >
                  <img
                    src="./assets/images/education/education__3.png"
                    class="absolute -right-4 top-[-22px] md:right-[155px] lg:-right-4 z-[-1] animate-move-hor"
                    alt=""
                  >
                </div>
                <div
                  class="w-300px md:w-342px absolute top-6 rihgt-0 md:top-[41px] md:right-[9px] lg:right-[-26px] 2xl:right-[-166px] bg-whiteColor p-10px flex gap-x-5 items-center animate-move-var shadow-hero-greeting dark:bg-whiteColor-dark"
                >
                  <div>
                    <img
                      src="./assets/images/about/about_16.png"
                      class="w-55px h-55px rounded block"
                      alt=""
                    >
                  </div>
                  <div>
                    <p class="text-size-15 font-semibold text-greencolor3">
                      Congratulations!!
                    </p>
                    <p
                      class="text-sm text-contentColor dark:text-contentColor-dark"
                    >
                ...
                <div
                  class="absolute right-10 bottom-[-136px] md:right-[219px] md:bottom-[-105px] lg:right-[-50px] lg:bottom-[-125px] 2xl:right-10 2xl:bottom-[-105px]"
                >
                  <a href="#" class="flex group">
                    ...
                    <img
                      ...
                      class="w-52px h-52px transition-all duration-300 -ml-35px group-hover:-ml-30px"
                      alt=""
                    >
                    <img
                  ...
                  <div>
                    <p class="text-sm text-lightGrey3 mb-15px">
                      Join over
    ...
    <section>
      <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-30px">
          <!-- feature 1 -->
          <div
            class="p-5 md:p-26px md:pr-30px transition-all duration-300 border border-borderColor5 hover:border-primaryColor hover:shadow-feature flex rounded"
            data-aos="fade-up"
          >
            <div
              class="w-71.94px h-69.44px leading-69.44px bg-primaryColor bg-opacity-5 border border-primaryColor text-center mr-35px rounded-100 border-opacity-10"
            >
              <i class="icofont-video-alt text-size-26 text-primaryColor"></i>
            </div>
            <div class="">
              <h3>
                <a
                  class="text-xl lg:text-lg 3xl:text-xl font-semibold text-contentColor mb-1 hover:text-primaryColor dark:text-contentColor-dark dark:hover:text-primaryColor"
                  href="#"
                  >Video Training
                </a>
              </h3>
              <p class="text-sm text-lightGrey3">With unlimited courses</p>
            </div>
          </div>
          <!-- feature 2 -->
          <div
            class="p-5 md:p-26px md:pr-30px transition-all duration-300 border border-borderColor5 hover:border-greencolor hover:shadow-feature flex rounded"
            data-aos="fade-up"
          >
            <div
              class="w-71.94px h-69.44px leading-69.44px bg-greencolor bg-opacity-5 border border-greencolor text-center mr-35px rounded-100 border-opacity-10"
            >
              <i
                class="icofont-business-man-alt-1 text-size-26 text-greencolor"
              ></i>
            </div>
            <div class="">
              <h3>
                <a
                  class="text-xl lg:text-lg 3xl:text-xl font-semibold text-contentColor mb-1 hover:text-greencolor dark:text-contentColor-dark dark:hover:text-greencolor"
                  href="#"
                  >Expert Teaceher
                </a>
              </h3>
          ...
          <!-- feature 3 -->
          <div
            class="p-5 md:p-26px md:pr-30px transition-all duration-300 border border-borderColor5 hover:border-secondaryColor hover:shadow-feature flex rounded"
            data-aos="fade-up"
          >
            <div
              class="w-71.94px h-69.44px leading-69.44px bg-secondaryColor bg-opacity-5 border border-secondaryColor text-center mr-35px rounded-100 border-opacity-10"
            >
              <i
                class="icofont-book-alt text-size-26 text-secondaryColor"
              ></i>
            </div>
            <div class="">
              <h3>
                <a
                  class="text-xl lg:text-lg 3xl:text-xl font-semibold text-contentColor mb-1 hover:text-secondaryColor dark:text-contentColor-dark dark:hover:text-secondaryColor"
                  href="#"
                  >Versatile Course
                </a>
              </h3>
    ...
    <section>
      <div class="container">
        <!-- about section  -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-30px pt-20">
          <!-- about left -->
          ...
          <div data-aos="fade-up">
            ...
            <p
              class="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark mb-6"
            >
            ...
            <ul class="space-y-5">
              <li class="flex items-center group">
                <i
                  class="icofont-check text-primaryColor mr-15px border border-primaryColor rounded-full"
                ></i>
                <p
                  class="text-sm md:text-base text-blackColor dark:text-blackColor-dark"
                >
            ...
            <div class="mt-10">
              <a
                class="text-size-15 text-whiteColor bg-primaryColor px-25px py-10px border border-primaryColor hover:text-primaryColor hover:bg-whiteColor inline-block rounded dark:hover:bg-whiteColor-dark dark:hover:text-whiteColor"
                href="#"
                >More About <i class="icofont-long-arrow-right"></i>
              </a>
            </div>
          </div>
        </div>
    ...
    <section class="py-50px pb-20">
      <div class="container">
        <!--Subject Header  -->
        <div
          class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-30px mb-65px"
        >
          <div class="lg:col-star-1 lg:col-span-4">
            ...
            >
              Populer
              <span
                class="relative after:w-full after:h-[7px] after:bg-secondaryColor after:absolute after:left-0 after:bottom-3 md:after:bottom-4 after:z-[-1]"
                >Subjects</span
              >
            </h3>
          </div>
          ...
          <div class="lg:col-star-5 lg:col-span-5">
            <p
              class="text-sm md:text-base text-contentColor dark:text-contentColor-dark mb-10px 2xl:mb-50px 2xl:pl-50px"
              data-aos="fade-up"
            >
              Forging relationships between multi to national governments and
              global NGOs begins.
          ...
          <div
            class="lg:col-star-10 lg:col-span-3 flex lg:justify-end"
            data-aos="fade-up"
          >
            <div>
              <a
                ...
                href="course.html"
                >All Catagories <i class="icofont-long-arrow-right"></i>
              </a>
            </div>
          </div>
        </div>
          ...
          <div data-aos="fade-up">
            ...
            >
              ...
              <div>
                ...
                <p
                  class="text-contentColor group-hover:text-whiteColor leading-29px"
                >
                  Business is succes
                </p>
              </div>
      ...
      >
        ...
        <div class="container">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 pt-30px gap-x-30px">
            ...
            >
              <form
                class="p-35px pt-10 bg-lightGrey10 dark:bg-lightGrey10-dark rounded shadow-experience dark:shadow-standard-dark"
              >
                <h3
    ...
    <section>
      <div class="overflow-hidden">
        ...
        >
          ...
          <div class="tab">
            <div
              class="tab-links grid grid-cols-2 md:grid-cols-5 gap-11px text-blackColor text-lg lg:text-size-22 font-semibold font-hind bg-transparent mt-30px md:mt-0 mb-43px"
              data-aos="fade-up"
            >
              <button
                class="py-9px lg:py-6 hover:text-primaryColor dark:text-whiteColor dark:hover:text-primaryColor bg-white dark:bg-whiteColor-dark dark:hover:bg-whiteColor-dark hover:bg-white relative group/btn shadow-bottom dark:shadow-standard-dark hover:shadow-bottom disabled:cursor-pointer rounded-standard"
              >
                <span
            ...
            <div class="tab-contents">
              ...
              <!-- Tuesday Event-->
              <div
                class="opacity-100 transition-opacity duration-150 ease-linear hidden"
              >
                <div class="flex flex-col gap-y-6">
                  <!-- event 1 -->
                  <div
