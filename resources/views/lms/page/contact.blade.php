...
<main class="bg-transparent">
  ...
  <section>
    <div class="container">
      <div
        class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-30px pt-100px pb-20"
      >
        <!-- mail -->
        <div
  ...
  <section>
    <div class="container pb-100px">
      <form id="contact-form" action="mail.php" method="post" class="contact-form p-5 md:p-70px md:pt-90px border border-borderColor2 dark:border-transparent dark:shadow-container" data-aos="fade-up" >
        <!-- heading -->
        <div class="mb-10">
          <h4
            class="text-size-23 md:text-size-44 font-bold leading-10 md:leading-70px text-blackColor dark:text-blackColor-dark"
            data-aos="fade-up"
          >
            Drop Us a Line
          </h4>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 mb-30px gap-30px">
          <div data-aos="fade-up" class="relative">
            ...
            <div
              class="text-xl leading-23px text-primaryColor absolute right-6 top-1/2 -translate-y-1/2"
            >
              <i class="icofont-businessman"></i>
            </div>
          </div>
          <div data-aos="fade-up" class="relative">
            <input name="con_email" id="con_email" type="email" placeholder="Enter Email Address*" class="w-full pl-26px bg-transparent focus:outline-none text-contentColor dark:text-contentColor-dark border border-borderColor2 dark:border-borderColor2-dark placeholder:text-placeholder placeholder:opacity-80 h-15 leading-15 font-medium rounded"
            >
        ...
        <div class="relative" data-aos="fade-up">
          <textarea name="con_message" id="con_message" placeholder="Enter your Massage here" class="w-full pl-26px bg-transparent text-contentColor dark:text-contentColor-dark border border-borderColor2 dark:border-borderColor2-dark placeholder:text-placeholder placeholder:opacity-80 rounded" cols="30"
            rows="10"></textarea>
        ...
        <div class="mt-30px" data-aos="fade-up">
          <button value="submit" name="submit" class="text-size-15 text-whiteColor bg-primaryColor px-25px py-10px border border-primaryColor hover:text-primaryColor hover:bg-whiteColor inline-block rounded group dark:hover:text-whiteColor dark:hover:bg-whiteColor-dark"
          >
            Post a Comment
          </button>
