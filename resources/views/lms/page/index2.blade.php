...
<main class="bg-transparent">
          ...
          <div class="grid grid-cols-1 md:grid-cols-12 items-center gap-30px">
            ...
            >
              <div class="3xl:pr-135px">
                ...
                >
                  Ignite Your
                  <span class="text-secondaryColor">Career</span> with
                  Learning the Largest
                  <span class="text-secondaryColor">Online</span>
                  Platform.
                </h1>
                <p
                  ...
                  >
                    <div class="">
                      ...
                      <div>
                        ...
                        <a
                          href="course-details.html"
                          class="text-2xl font-semibold text-blackColor mb-10px font-hind dark:text-blackColor-dark hover:text-primaryColor dark:hover:text-primaryColor"
                        >
                          Figma to HTML
                        </a>
                        <p
    ...
    <section>
      <div class="container">
        <!-- about section  -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-30px pb-30px">
          <!-- about left -->
          <div
            class="mb-20 lg:mb-0 pb-0 md:pb-30px xl:pb-0 overflow-visible"
            data-aos="fade-up"
          >
          ...
          <div data-aos="fade-up">
            ...
            <h3
              class="text-3xl md:text-size-45 leading-10 md:leading-2xl font-bold text-blackColor dark:text-blackColor-dark"
            >
              Welcome to the
              <span
    ...
    <section>
      <div
        class="container py-30px md:pt-10 md:pb-50px 2xl:pt-50px 2xl:pb-100px"
      >
        <!-- heading -->
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-30px">
          ...
          <div data-aos="fade-up">
            <div class="mb-5 relative group">
              ...
              <!-- social icons -->
              <div
                class="absolute transition-all duration-300 right-0 top-5 opacity-0 group-hover:opacity-100 group-hover:right-5"
              >
                <ul class="flex flex-col gap-10px">
                  <li>
                    <a
                      href="#"
                      class="w-41px h-41px leading-41px bg-whiteColor text-darkdeep4 hover:bg-primaryColor hover:text-whiteColor dark:bg-whiteColor-dark dark:hover:bg-primaryColor dark:hover:text-whiteColor text-base rounded text-center"
            ...
            <div>
              <p
                class="text-base text-contentColor dark:text-contentColor-dark uppercase mb-1"
              >
                INTERIOR DESIGNER
              </p>
              <h5>
                <a
                  href="instructor-details.html"
                  class="text-2xl font-semibold text-contentColor dark:text-contentColor-dark hover:text-primaryColor dark:hover:text-primaryColor mb-15px"
                >
                  Mirnsdo Jons
                </a>
              </h5>
